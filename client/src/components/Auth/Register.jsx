    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="text-center lg:text-left">
          <h1 className="text-5xl font-bold text-white mb-6">Créez votre compte !</h1>
          <p className="text-xl text-gray-300">
            Rejoignez-nous pour une gestion optimale de vos tâches.
            Commencez dès maintenant votre parcours vers la productivité ! 🚀
          </p>
        </div>
        
        <div className="bg-gray-800 rounded-xl shadow-2xl p-8 w-full max-w-md mx-auto">
          <form onSubmit={handleSubmit}>
            <h2 className="text-3xl font-bold text-center mb-8 text-white">Inscription</h2>
